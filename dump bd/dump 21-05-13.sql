...
INSERT INTO `form_messages` (`id`, `nom`, `prenom`, `email`, `entite_id`, `contenu`) VALUES
(2, 'zadzd', 'zdzd', 'zdzd@gmail.com', 32, 'zdzdd');
...
--
DROP TRIGGER IF EXISTS `form_photos_OnInsert`;
DELIMITER //
CREATE TRIGGER `form_photos_OnInsert` BEFORE INSERT ON `form_photos`
 FOR EACH ROW SET NEW.date_upload = NOW()
//
DELIMITER ;
