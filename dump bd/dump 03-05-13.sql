...
--
-- Client: localhost
-- Généré le: Ven 03 Mai 2013 à 09:24
...
INSERT INTO `actualites` (`id`, `date_creation`, `titre`, `contenu`, `last_updated`) VALUES
...
(19, 'Le dÃ©fi Test', 'Hugo Rodde', 2, '195.83.155.55', 'Simple', 12, 123, '', '', '', '', '', '', '', '', '2013-04-09 19:09:02', 0),
(20, 'tests', 'efefef', 2, '', '', 0, 0, '', '', '', '', '', '', '', '', '2013-05-02 00:00:00', 0);
...
CREATE TABLE IF NOT EXISTS `partenaires` (
  ...
  `fk_departement` varchar(2) NOT NULL,
  `cp` int(5) NOT NULL,
  `description` text NOT NULL,
  `fichier_logo` varchar(50) DEFAULT NULL,
  `afficher` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
ALTER TABLE `partenaires`
  ADD CONSTRAINT `partenaires_ibfk_1` FOREIGN KEY (`fk_departement`) REFERENCES `departements` (`num_departement`);

--
-- Contraintes pour la table `photos`
--
ALTER TABLE `photos`
  ADD CONSTRAINT `photos_ibfk_1` FOREIGN KEY (`uploader`) REFERENCES `clans` (`id`),
  ADD CONSTRAINT `photos_ibfk_2` FOREIGN KEY (`fk_defi`) REFERENCES `form_defis` (`id`);
