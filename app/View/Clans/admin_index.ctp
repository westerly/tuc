<div class="clans index">
	...
	<tr>
		<td><?php echo h($clan['Clan']['id']); ?>&nbsp;</td>
		<td><?php echo h($clan['Clan']['nom']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $clan['Clan']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $clan['Clan']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $clan['Clan']['id']), null, __('Are you sure you want to delete # %s?', $clan['Clan']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
