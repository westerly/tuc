...
<?php echo $this->Form->create('Defi'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Defi'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Defi.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Defi.id'))); ?></li>
