	...
	<div id="path"><?= $this->Html->link($this->Html->image('front/home.png', array('alt' => 'home')).' Accueil', $this->Html->url(array('controller'=>'accueil', 'action'=>'index')), array('escape'=>false)) ?>
			...
			<article class="content-accueil">
				<h2>Le Projet TUC</h2>
                                <?= $this->Html->image('front/accueil.jpg', array('alt'=>'accueil', 'width'=> 470, 'height'=>350)); ?>
			...
			<article class="liste-defis">
				...
				<div id="slider">
                                    ...
                                    <?= $this->Html->image('front/band1.jpg', array('width'=>1004, 'height'=>290)); ?>
                                    <?= $this->Html->image('front/band2.jpg', array('width'=>1004, 'height'=>290)); ?>
                                    <?= $this->Html->image('front/band3.jpg', array('width'=>1004, 'height'=>290)); ?>
				</div>
