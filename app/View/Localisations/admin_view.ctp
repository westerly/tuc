<div class="localisations view">
<h2><?php  echo __('Localisation'); ?></h2>
	<dl>
		<dt><?php echo __('Localisation Id'); ?></dt>
		<dd>
			<?php echo h($localisation['Localisation']['localisation_id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Lieu'); ?></dt>
		<dd>
			<?php echo h($localisation['Localisation']['lieu']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Localisation'), array('action' => 'edit', $localisation['Localisation']['localisation_id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Localisation'), array('action' => 'delete', $localisation['Localisation']['localisation_id']), null, __('Are you sure you want to delete # %s?', $localisation['Localisation']['localisation_id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($localisation['Defi'])): ?>
	...
	<?php
		$i = 0;
		foreach ($localisation['Defi'] as $defi): ?>
		<tr>
